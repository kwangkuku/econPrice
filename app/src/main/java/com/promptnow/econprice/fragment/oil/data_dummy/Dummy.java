...
public class Dummy {
    ...
    public List<String> bangchak_day_10 = new ArrayList<>(Arrays.asList("32.25", "23.66", "23.99", "21.81", "17.18", "23.44"));
    ...
    public List<String> bangchak_day_18 = new ArrayList<>(Arrays.asList("25.25", "34.11", "22.55", "21.23", "13.55", "23.94"));
    ...
    public List<String> bangchak_day_27 = new ArrayList<>(Arrays.asList("23.15", "-", "22.33", "27.97", "18.65", "28.31"));
