...
//
//            // Row1
//            TextView tv_bs_colum1 = (TextView) getActivity().findViewById(R.id.bensin_ptt);
//            tv_bs_colum1.setText(Dummy.getInstance().ptt_day_10.get(0) + " ");
//
//            TextView tv_bs_colum2 = (TextView) getActivity().findViewById(R.id.bensin_bangjak);
//            tv_bs_colum2.setText(Dummy.getInstance().bangjak_day_10.get(0) + " ");
//
//            TextView tv_bs_colum3 = (TextView) getActivity().findViewById(R.id.bensin_shell);
//            tv_bs_colum3.setText(Dummy.getInstance().shell_day_10.get(0) + " ");
//
//            TextView tv_bs_colum4 = (TextView) getActivity().findViewById(R.id.bensin_esso);
//            tv_bs_colum4.setText(Dummy.getInstance().esso_day_10.get(0) + " ");
//
//            // Row2
//            TextView tv_gsh95_colum1 = (TextView) getActivity().findViewById(R.id.gasohol95_ptt);
