...
public class UtilCalendar {
    //   @SuppressLint("NewApi")
    private static Calendar c = Calendar.getInstance(Locale.US);
    ...
    public static void setCalendar(String date) {
        if (date.length() == 8) {
            ...
            Log.e("", "can't set date because length != 8");
        }
    }
...
//			c.set(Calendar.MONTH, c.get(c.MONTH));
    ...
    public static String getStringAmountDayInMounthNum(int monthBefore, String date) {
        ...
        if (date.length() == 8) {
            ...
            Log.d("", lastYear + " - " + lastMonth + " - " + lastDay);
...
//		log(sYear+" - "+sMonth+" - "+sDay);
    ...
    public static void main(String[] args) {
        ...
        Log.d("", "month : " + theMonth + " has : " + list.get(0) + ", " + list.get(1));
    }
}
