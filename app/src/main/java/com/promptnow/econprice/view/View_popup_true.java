...
public class View_popup_true extends DialogFragment {
    ...
    public View_popup_true(String message, String button1) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        dialog.setContentView(R.layout.activity_popup_true);
